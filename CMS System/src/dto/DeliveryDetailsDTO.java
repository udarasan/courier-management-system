...
public class DeliveryDetailsDTO {
    ...
    public DeliveryDetailsDTO(String DID, String BID, String DFirstName, String DSecondName, String DTelephoneNO, String DAddress, String dueDate, String orderAction) {
        this.setDID(DID);
        this.setBID(BID);
